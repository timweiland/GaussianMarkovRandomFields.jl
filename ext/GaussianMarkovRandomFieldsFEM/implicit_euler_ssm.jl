...
function ImplicitEulerSSM(
    ...
    return ImplicitEulerSSM{X, S, GF, MF, MIF, BF, BIF, TS, C, V}(
        x₀,
        G,
        M,
        M⁻¹,
...
"""
    ImplicitEulerJointSSMMatrices(ssm::ImplicitEulerSSM, Δt::Real)
...
function ImplicitEulerJointSSMMatrices(ssm::ImplicitEulerSSM, Δt::Real)
    ...
    return ImplicitEulerJointSSMMatrices{
        typeof(Δt), typeof(G), typeof(M), typeof(Σ⁻¹), typeof(Σ⁻¹_sqrt),
        typeof(ssm.constraint_handler), typeof(ssm.constraint_noise),
